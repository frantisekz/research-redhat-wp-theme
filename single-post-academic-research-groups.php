...
<div class="dropdown" style="float: left;">
  	...
  	<ul class="dropdown-menu" aria-labelledby="university_drop_down">
  		<?php 
		$generic_terms_place = get_terms(['taxonomy' => 'research_group_location', 'hide_empty' => false]);
...
<div class="dropdown" style="float: left;">
  ...
  <ul class="dropdown-menu" aria-labelledby="spec_drop_down">
  		<?php 
		$generic_terms_tags = get_terms(['taxonomy' => 'research_group_tags', 'hide_empty' => false]);
...
<button class="btn btn-white btn-default master-reset-btn" onclick="reset_filter(1)">Reset Filters</button>
			...
			<?php
				...
				$terms_category = wp_get_post_terms(get_the_ID(), 'research_group_tags');
				$terms_place = wp_get_post_terms(get_the_ID(), 'research_group_location');
			?>
