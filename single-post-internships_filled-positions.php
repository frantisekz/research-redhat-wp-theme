	...
	<div class="row">
		...
		<div class="col-md-4 text-right">
			<form class="search" action="<?php echo home_url( '/' ); ?>">
					...
					<input type="hidden" name="post_type" value="filled_internships">
			</form>
		</div>
	</div>
            ...
            'ignore_sticky_posts' => 1);
			  ...
			  $terms_uni = wp_get_post_terms(get_the_ID(), 'filled_internships_locations');
			  ?>
