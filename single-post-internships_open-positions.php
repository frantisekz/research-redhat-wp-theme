	...
	<div class="row">
		<div class="col-md-6">
			<div class="dropdown" style="float: left;">
				...
				<ul class="dropdown-menu" aria-labelledby="university_drop_down">
					<?php 
					$generic_terms_place = get_terms(['taxonomy' => 'internships_locations', 'hide_empty' => false]);
			...
			<ul class="dropdown-menu" aria-labelledby="spec_drop_down">
					<?php 
					$generic_terms_tags = get_terms(['taxonomy' => 'internships_tags', 'hide_empty' => false]);
		...
		<div class="col-md-4 text-right">
			<form class="search" action="<?php echo home_url( '/' ); ?>">
					...
					<input type="hidden" name="post_type" value="internships_cpt">
			</form>
		</div>
	</div>
            ...
            'ignore_sticky_posts' => 1);
			  ...
			  $terms_category = wp_get_post_terms(get_the_ID(), 'internships_tags');
			  $terms_uni = wp_get_post_terms(get_the_ID(), 'internships_locations');
			  ?>
